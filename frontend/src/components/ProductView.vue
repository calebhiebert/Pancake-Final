    ...
    <div class="ui fluid container">
        ...
        <div class="ui stackable three column grid" v-else>
            ...
            <div class="eight wide column">
                ...
                <div class="ui blue label" v-if="moment(product.created_at).isBetween(moment().subtract(5, 'days'), moment())">New!</div>
                <div class="ui blue label" v-else-if="moment(product.updated_at).isBetween(moment().subtract(5, 'days'), moment())">Recently Updated!</div>
